...
test('happy-css: parser: selector: id', (t) => {
    t.transform('selector-id');
    t.end();
});

test('happy-css: parser: selector: combinator', (t) => {
    t.transform('selector-combinator');
    t.end();
});

test('happy-css: parser: selector: pseudo-element', (t) => {
    t.transform('selector-pseudo-element');
    t.end();
});

test('happy-css: parser: selector: attribute-bare', (t) => {
    t.transform('selector-attribute-bare');
    t.end();
});

test('happy-css: parser: selector: pseudo-class', (t) => {
...
test('happy-css: parser: selector: attribute-unquoted', (t) => {
