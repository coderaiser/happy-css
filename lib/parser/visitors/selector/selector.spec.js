...
test('happy-style: parser: selector: selector-nesting', (t) => {
    t.transform('selector-nesting');
    t.end();
});

test('happy-style: parser: selector: selector-pseudo-nth', (t) => {
    t.transform('selector-pseudo-nth');
    t.end();
});
